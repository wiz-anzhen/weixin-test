...
{
    const ORDER_CHANGE_LOG_ID = 'order_change_log_id';
    ...
    public static function s_metadata()
    {
        if (!isset(self::$__metadata))
        {
            self::$__metadata = new ModelMetadata(
                ...
                'order_change_log_id',
                [
                    'order_change_log_id' => ['name' => _META_('mp.order_change_log.order_change_log_id'), 'type' => 'int', 'length' => 10, 'min' => 1, 'required' => true, 'db_insert' => true, 'rou' => true],
                    'order_id' => ['name' => _META_('mp.order_change_log.order_id'), 'type' => 'text', 'length' => 32, 'required' => true],
                    'operator' => ['name' => _META_('mp.order_change_log.operator'), 'type' => 'text', 'length' => 128, 'required' => true],
                    'change_time' => ['name' => _META_('mp.order_change_log.change_time'), 'type' => 'datetime', 'required' => true],
                    'comment' => ['name' => _META_('mp.order_change_log.comment'), 'type' => 'text', 'length' => 255, 'required' => true],
                    'status_before' => ['name' => _META_('mp.order_change_log.status_before'), 'type' => 'text', 'max' => 32, 'required' => true, 'enum' => new OrderStatus(), 'db_insert' => true],
                    'status_after' => ['name' => _META_('mp.order_change_log.status_after'), 'type' => 'text', 'max' => 32, 'required' => true, 'enum' => new OrderStatus(), 'db_insert' => true],
                ],
                [
                    'auto_increment_id' => 'order_change_log_id',
                ],
                [
                ],
                [
     ...
     * @return int
     */
    public function getOrderChangeLogID()
    {
        return $this->__get(self::ORDER_CHANGE_LOG_ID);
    }
     ...
     */
    public function setOrderChangeLogID($value)
    {
        $this->__set(self::ORDER_CHANGE_LOG_ID, $value);
