...
class CsChatRecord extends Model
{
    const CS_CHAT_RECORD_ID = 'cs_chat_record_id';
    ...
    public static function s_metadata()
    {
        if (!isset(self::$__metadata))
        {
            self::$__metadata = new ModelMetadata(
                ...
                'cs_chat_record_id',
                [
                    'cs_chat_record_id' => ['name' => _META_('mp.cs_chat_record.cs_chat_record_id'), 'type' => 'int', 'length' => 10, 'min' => 1, 'required' => true, 'db_insert' => true, 'rou' => true],
                    'wx_user_id' => ['name' => _META_('mp.cs_chat_record.wx_user_id'), 'type' => 'text', 'length' => 64, 'required' => true],
                    'mp_user_id' => ['name' => _META_('mp.cs_chat_record.mp_user_id'), 'type' => 'int', 'length' => 10, 'required' => true],
                    'wx_user_name' => ['name' => _META_('mp.cs_chat_record.wx_user_name'), 'type' => 'text', 'length' => 128],
                    'community_id' => ['name' => _META_('mp.cs_chat_record.community_id'), 'type' => 'int', 'length' => 10, 'required' => true],
                    'vip_no' => ['name' => _META_('mp.cs_chat_record.vip_no'), 'type' => 'int', 'length' => 20, 'required' => true],
                    'group_name' => ['name' => _META_('mp.cs_chat_record.group_name'), 'type' => 'text', 'length' => 128],
                    'cs_name' => ['name' => _META_('mp.cs_chat_record.cs_name'), 'type' => 'text', 'length' => 128],
                    'content_value' => ['name' => _META_('mp.cs_chat_record.content_value'), 'type' => 'text', 'required' => true],
                    'cs_group_id' => ['name' => _META_('mp.cs_chat_record.cs_group_id'), 'type' => 'int', 'length' => 10],
                    'cs_id' => ['name' => _META_('mp.cs_chat_record.cs_id'), 'type' => 'int', 'length' => 10],
                    'record_time' => ['name' => _META_('mp.cs_chat_record.record_time'), 'type' => 'datetime', 'required' => true],
                    'content_type' => ['name' => _META_('mp.cs_chat_record.content_type'), 'type' => 'text', 'max' => 32, 'required' => true, 'enum' => new ReocrdContentType(), 'db_insert' => true],
                ],
                [
                    'auto_increment_id' => 'cs_chat_record_id',
                ],
                [
                ],
                [
     ...
     * @return int
     */
    public function getCsChatRecordID()
    {
        return $this->__get(self::CS_CHAT_RECORD_ID);
    }
     ...
     * @return CsChatRecord
     */
    public function setCsChatRecordID($value)
    {
        $this->__set(self::CS_CHAT_RECORD_ID, $value);
