    ...
    public static function s_metadata()
    {
        if (!isset(self::$__metadata))
        {
            self::$__metadata = new ModelMetadata(
                ...
                'cart_id',
                [
                    'cart_id' => ['name' => _META_('mp.cart.cart_id'), 'type' => 'int', 'length' => 10, 'min' => 1, 'required' => true, 'db_insert' => true, 'rou' => true],
                    '_created_at' => ['name' => _META_('mp.cart._created_at'), 'type' => 'timestamp', 'required' => true, 'default' => new DbExpr('NOW()'), 'roc' => true, 'rou' => true],
                    'mp_user_id' => ['name' => _META_('mp.cart.mp_user_id'), 'type' => 'int', 'length' => 10, 'required' => true],
                    'store_id' => ['name' => _META_('mp.cart.store_id'), 'type' => 'int', 'length' => 10, 'required' => true],
                    'wx_user_id' => ['name' => _META_('mp.cart.wx_user_id'), 'type' => 'text', 'length' => 64, 'required' => true],
                ],
                [
                    'auto_increment_id' => 'cart_id',
                    'create_timestamp' => '_created_at',
                    'unique_keys' => [['mp_user_id', 'store_id', 'wx_user_id']],
                ],
                [
                ],
                [
