...
class UserNotifyAppCController extends CommunityControllerBase
{
    protected function _init()
    {
        $this->_moduleName = "user_notify_app_c";
        parent::_init();
    }
    //显示
    public function listAction()
    {
        ...
        $condition     = [ UserNotify::MP_USER_ID => $mpUserId,UserNotify::COMMUNITY_ID => $communityId,UserNotify::SEND_TYPE => "app_c"];
                ...
                Table::COLUMN_FUNCTION => function(array $row)
                    {
                        ...
                        $update = new Link('修改', "javascript:bluefinBH.ajaxDialog('/mp_admin/user_notify_dialog/update?user_notify_id={$userNotifyId}&community_id={$community_id}&from=app_c');");
                        ...
                        $send = new Link('发布', "javascript:bluefinBH.confirm('确定要发布消息吗？', function() { javascript:wbtAPI.call('../fcrm/user_notify/send?user_notify_id={$userNotifyId}&mp_user_id={$mpUserID}&community_id={$community_id}&from=app_c', null, function(){bluefinBH.showInfo('发布成功', function() { location.reload(); }); }); })");
                        ...
                        $copy = new Link(' 复制', "javascript:bluefinBH.confirm('确定要复制此消息吗？', function() { javascript:wbtAPI.call('../fcrm/user_notify/copy?user_notify_id={$userNotifyId}&mp_user_id={$mpUserID}&community_id={$community_id}&from=app_c', null, function(){bluefinBH.showInfo('复制成功', function() { location.reload(); }); }); })");
