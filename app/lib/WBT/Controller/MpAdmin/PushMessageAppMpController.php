...
class PushMessageAppMpController extends CommunityControllerBase
{
    protected function _init()
    {
        $this->_moduleName = "push_message_app_mp";
        parent::_init();
    }
    //显示
    public function listAction()
    {
        ...
        $condition     = [ PushMessage::MP_USER_ID => $mpUserId,PushMessage::COMMUNITY_ID => $communityId,PushMessage::SEND_TYPE => "app_mp"];
                ...
                Table::COLUMN_FUNCTION => function(array $row)
                    {
                        ...
                        $update = new Link('修改', "javascript:bluefinBH.ajaxDialog('/mp_admin/push_message_dialog/update?push_message_id={$pushMessageId}&community_id={$community_id}&from=app_mp');");
                        ...
                        $send = new Link('发布', "javascript:bluefinBH.confirm('确定要发布消息吗？', function() { javascript:wbtAPI.call('../fcrm/push_message/send?push_message_id={$pushMessageId}&mp_user_id={$mpUserID}&community_id={$community_id}&from=app_mp', null, function(){bluefinBH.showInfo('发布成功', function() { location.reload(); }); }); })");
                        ...
                        $copy = new Link(' 复制', "javascript:bluefinBH.confirm('确定要复制此消息吗？', function() { javascript:wbtAPI.call('../fcrm/push_message/copy?push_message_id={$pushMessageId}&mp_user_id={$mpUserID}&community_id={$community_id}&from=app_mp', null, function(){bluefinBH.showInfo('复制成功', function() { location.reload(); }); }); })");
