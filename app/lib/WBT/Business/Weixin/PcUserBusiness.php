...
// 普通微信用户相关的一些操作
class PcUserBusiness extends BaseBusiness
{
    ...
    public static function getPcUserList( array $condition, array &$paging = NULL, $ranking,  array $outputColumns = NULL )
    {
        return PcUser::fetchRowsWithCount( [ '*' ], $condition, NULL, $ranking, $paging,$outputColumns );
    }
