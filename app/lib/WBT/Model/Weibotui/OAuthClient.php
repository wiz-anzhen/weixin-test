        ...
        if (!isset(self::$__metadata))
        {
            self::$__metadata = new ModelMetadata(
                ...
                [
                    ...
                    'secret' => ['name' => _META_('weibotui.oauth_client.secret'), 'type' => 'text', 'length' => 32, 'filter' => new \Bluefin\Data\Functor\VarTextProvider('{{this.secret|.=this.redirect_uri|md5}}'), 'required' => true],
