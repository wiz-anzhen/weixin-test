...
CREATE TABLE IF NOT EXISTS `procurement_order_detail` (
    `procurement_order_detail_id` INT(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    ...
    UNIQUE KEY `uk_procurement_order_detail_order_product_id` (`order_id`,`product_id`,`part_id`)
