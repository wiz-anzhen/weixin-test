...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL =  window.location.protocol + '//' + window.location.host + "/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'removeformat', 'formatmatch' ,'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist',
                'lineheight',
                 'paragraph', 'fontfamily', 'fontsize',

                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify',
                'link', 'unlink',
                'insertimage', 'emotion', 'map','source']
        ]
...
//        }
       ...
       // ,initialFrameHeight:500  //初始化编辑器高度,默认320
        ...
        ,initialStyle:'body{margin:4px;font-family:微软雅黑,Microsoft YaHei;font-size:16px;line-height:150%} p{line-height:1em}'  //编辑器层级的基数,可以用来改变字体等
...
//           ]
        ...
        //,minFrameHeight:920  //编辑器拖动时最小高度,默认220
