...
class Gateway implements ContextProviderInterface
{
    ...
    public function service()
    {
        ...
        catch (RequestException $reqEx)
        {
            ...
            log_warn('Request Exception: ' . $reqEx->getMessage());
        }
        catch (ServerErrorException $srvEx)
        {
            ...
            $trace = $srvEx->getTraceAsString();
            log_error('Server Error: ' .  $srvEx->getMessage() . '<br><br>' . replace_nl_to_br($trace) . "\n" . $trace);
        }
        catch (Exception $e)
        {
    ...
    public function url($relativeUrl = null, array $queryParams = null, array $fragmentParams = null, $checkSum = false)
    {
        ...
        return build_uri($url, $queryParams, $fragmentParams, $checkSum);
    }

    public function path($relativeUrl = null, array $queryParams = null, array $fragmentParams = null, $checkSum = false)
    {
        if (!isset($relativeUrl))
        {
