...
class Ymd extends SimpleComponent
{
    public $collection;
    public $stringValue;
    public $arrayValue;
    ...
    protected function _renderContent()
    {
        ...
        $select1 = "<select name = 'hour_start' style='width:90px;' tag='year'";
        $select1 .= sprintf(" id='year%s' ",$id);
        $select1 .= ">
            <option value='2014'";
       ...
       <option value='2019'";
        ...
        $content .= $select1 . "&nbsp;年&nbsp;&nbsp;" . $select2 . "&nbsp;月&nbsp;" . $select4 . "&nbsp;日&nbsp;";
